...
public class User implements Messages{
	...
	public void addAttribute(String key,String value) throws InvalidFormatException{
	...
	public void editAttribute(String key,String value) throws InvalidFormatException,IllegalArgumentException {
		if(key.length()<3 || value.length()<3) {
			InvalidFormatException formatInvalid = new InvalidFormatException();
			throw formatInvalid;
